...
import com.wordapp.pfdview.link.DefaultLinkHandler;
import com.wordapp.pfdview.link.LinkHandler;
import com.wordapp.pfdview.listener.Callbacks;
import com.wordapp.pfdview.listener.OnDrawListener;
import com.wordapp.pfdview.listener.OnErrorListener;
import com.wordapp.pfdview.listener.OnLoadCompleteListener;
import com.wordapp.pfdview.listener.OnLongPressListener;
import com.wordapp.pfdview.listener.OnPageChangeListener;
import com.wordapp.pfdview.listener.OnPageErrorListener;
import com.wordapp.pfdview.listener.OnPageScrollListener;
import com.wordapp.pfdview.listener.OnRenderListener;
import com.wordapp.pfdview.listener.OnTapListener;
import com.wordapp.pfdview.model.PagePart;
...
import com.wordapp.pfdview.source.AssetSource;
import com.wordapp.pfdview.source.ByteArraySource;
import com.wordapp.pfdview.source.DocumentSource;
import com.wordapp.pfdview.source.FileSource;
import com.wordapp.pfdview.source.InputStreamSource;
import com.wordapp.pfdview.source.UriSource;
import com.wordapp.pfdview.util.Constants;
import com.wordapp.pfdview.util.FitPolicy;
import com.wordapp.pfdview.util.MathUtils;
...
public class PDFView extends RelativeLayout {
    ...
    public void notifyItemAdded(PDocSearchTask pDocSearchTask, ArrayList<SearchRecord> arr, SearchRecord schRecord, int pageNumber) {
        searchRecords.put(pageNumber, schRecord);
    ...
    public void redrawSel() {
        if (selectionPaintView != null) {
            ...
            selectionPaintView.pointerEvent = PDocSelection.PointerEvent.NONE;
        }
    }
